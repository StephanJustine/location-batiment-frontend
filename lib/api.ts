...
export const dashboardService = {
  ...
  getEvolution: async (p0?: number) => { try { const r = await api.get('/dashboard/evolution?mois=12'); return r.data; } catch { return []; } },
  getPerformanceBatiments: async () => { try { const r = await api.get('/dashboard/performance/batiments'); return r.data; } catch { return []; } },
  getTopLocataires: async (p0?: number) => { try { const r = await api.get('/dashboard/top-locataires?limit=10'); return r.data; } catch { return []; } },
